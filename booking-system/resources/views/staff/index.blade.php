    ...
    <x-slot name="header">
        <div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
            ...
            <a href="{{ route('staff.create') }}"
               style="background:#2563eb; color:#ffffff; padding:8px 16px; border-radius:6px; text-decoration:none;">
                + Add Staff
            </a>
        </div>
    </x-slot>
                    ...
                    @forelse($staff as $member)
                        <tr style="border-bottom:1px solid #eee;">
                            ...
                            <td style="padding:12px; text-align:right;">
                                <a href="{{ route('staff.working-hours.edit', $member) }}"
                                    style="color:#16a34a; text-decoration:none; margin-right:12px;">
                                        Working Hours
                                </a>
                                <a href="{{ route('staff.edit', $member) }}" style="color:#2563eb; text-decoration:none;">
                                    Edit
                                </a>

                                <form action="{{ route('staff.destroy', $member) }}" method="POST" style="display:inline-block; margin-left:12px;">
                                    @csrf
                                    @method('DELETE')
